...
def game_config() -> dict[str, object]:
    return {
        ...
        "features": [
            ...
            "redesigned-weapon-models",
            "rigged-gltf-hero",
            "skeletal-animation-mixer",
            "pbr-materials",
            "facial-morph-targets",
            "cmu-mocap-locomotion",
            "procedural-hero-default",
            "articulated-enemy-models",
            ...
            "dynamic-context-camera",
            "analog-walk-run-locomotion",
            "weapon-specific-animation-profiles",
            "combat-camera-impulses",
            "quests",
            "local-save",
            "pwa",
        ],
